        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RainAmountMm = table.Column<decimal>(type: "decimal(8,2)", nullable: true),
                    WindSpeed = table.Column<decimal>(type: "decimal(8,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeatherData_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinAirHumidity = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    MaxAirHumidity = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    ...
                    DailyWaterNeedLiters = table.Column<decimal>(type: "decimal(8,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlantProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlantProfiles_PlantCategories_PlantCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlantProfiles_PlantCategoryId_Name",
                table: "PlantProfiles",
                columns: new[] { "PlantCategoryId", "Name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Plants_AreaId_Name",
                table: "Plants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorReadings_SensorId_ReadAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeatherData_AreaId_ForecastDate",
                table: "WeatherData",
                columns: new[] { "AreaId", "ForecastDate" });
        }
